...
<body>
		...
		<div class="cor">
			...
			<div class="container"> 
				<div class="row box-pro-text-heard">
					<h2 style="padding-left:15px;">สินค้าแนะนำ flex </h2>
				</div>				
				<!-- ROW -->
    ...
    <script>                
        ...
        //     if(pro.type==b) {
        //     $('#result').append('<a href="product-page.php"><div class="box-flex"><img class="img-size " src="'+pro.sku+'" alt=""><div class="f">Lotus ที่นอน รุ่น Evan หนา 8 นิ้ว ของแถม 10 รายการ ส่งฟรี</div><div style="   margin-top: 8px;  margin-left: 3px;"><span class="font-1-2-1" ><i class="fa fa-truck"></i> จัดส่งฟรี เมื่อสั่งซื้อขั้นต่ำ ฿400</span></div><div><span ><strong class="tex-pr">฿</strong></span><span class="tex-p">200</span></div></div></a>');
        //     }})
